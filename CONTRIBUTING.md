...
1. Projenin GitHub sayfasında [Issues](https://github.com/mustafayaliniz/Labirent_DQN/issues) sekmesine gidin.
...
2. Kendi forkladığınız projeyi yerel bilgisayarınıza klonlayın:
    ```bash
    git clone https://github.com/kendi-kullanici-adiniz/Labirent_DQN.git
    ```
